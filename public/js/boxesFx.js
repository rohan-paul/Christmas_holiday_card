...
;( function( window ) {
	...
	BoxesFx.prototype._init = function() {
		...
		// Creating the slidesCount variable so to make the project take any number of images. for this also have to make the corresponding changes in line
	...
	BoxesFx.prototype._navigate = function( dir ) {
		...
		// Old code commented out, to implement slidesCount variable here so the project take any number of images.
